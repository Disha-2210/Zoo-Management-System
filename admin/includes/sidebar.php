   <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <p style="color: white">🦊ZOOTOPIA🐰 ADMIN</p>
                </div>
            </div>
            <div class="main-menu">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                             ...
                             <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Animal Details</span></a>
                                <ul class="collapse">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Foreigner Ticket</span></a>
                                <ul class="collapse">
