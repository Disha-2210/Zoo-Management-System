...
<head>
    ...
    <title>🦊ZOOTOPIA🐰 || Dashboard</title>
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">Today's Normal Adult Visitor</h3>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">Today's Normal Children Visitor</h4>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday's Normal Adult Visitor</h4>
...
$count_Yest_cvisitors=$result['totalchildy'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday's Normal Child Visitor</h4>
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">Today's Foreigner Adult Visitor</h3>
                                       <p style="font-size: 20px;color: red"><?php echo $count_today_visitors?></p>
                                    </div>
                                </div>
                            </div>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">Today's Foreigner Children Visitor</h4>
                                        <p style="font-size: 20px;color: red"><?php echo $count_today_cvisitors?></p>
                                    </div>
                                </div>
                            </div>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday's Foreigner Adult Visitor</h4>
                                        <p style="font-size: 20px;color: red"><?php echo $count_Yest_visitors?></p>
                                    </div>
                                </div>
...
$count_Yest_cvisitors=$result['totalchildy'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday's Foreigner Child Visitor</h4>
                                        <p style="font-size: 20px;color: red"><?php echo $count_Yest_cvisitors?></p>
                                    </div>
                                </div>
                            </div>
